...
export const getSubmissionReview = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { id } = req.params;
...
export const getSubmissionsForAssignment = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    const { id: assignmentId } = req.params;
