...
import { authenticate } from '../middlewares/auth.middleware'; // Jalur baru ke middleware
import { checkRole } from '../middlewares/role.middleware'; // Jalur baru ke middleware
