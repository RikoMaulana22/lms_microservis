// Path: client/app/admin/kelas/page.tsx
"use client";
...
export default function ClassManagementPage() {
    ...
    // ✅ PERBAIKAN: Satu fungsi untuk menangani sukses dan menutup modal
    ...
    return (
        <div className="container mx-auto p-4 text-gray-600 md:p-8">
            <AddClassModal
                ...
                // ✅ PERBAIKAN: Gunakan nama prop yang benar
                onClassCreated={handleActionSuccess} 
            />
            {selectedClass && (
                <EditClassModal
                    ...
                    // ✅ PERBAIKAN: Gunakan nama prop yang benar
                    onClassUpdated={handleActionSuccess}
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="divide-y divide-gray-200">
                        {classes.length > 0 ? classes.map(cls => (
                            ...
                            <tr>
                                <td colSpan={5} className="text-center py-4">Tidak ada data kelas yang ditemukan.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
