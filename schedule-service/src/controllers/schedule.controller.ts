...
export const getSchedulesByClass = async (req: AuthRequest, res: Response,  next: NextFunction): Promise<void> => {
...
export const getPublicSchedules = async (req: Request, res: Response,  next: NextFunction) => {
    try {
        const schedules = await prisma.schedule.findMany({
...
export const getAllSchedules = async (req: AuthRequest, res: Response,  next: NextFunction): Promise<void> => {
    try {
        const schedules = await prisma.schedule.findMany({
            include: {
                class: { select: { name: true } },
